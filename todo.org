...
* add mem/remalloc
** init with mpool * & it_size
** assert it_size in acquire
** ls freelist
** move back and forth between freelist / mpool
* add c4malloc example
** put remalloc on top of mpool on top of mslab
