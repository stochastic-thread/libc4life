...
** add c4fmt(prefix, fmt, ...)
*** build string with sprintf
*** get size
*** realloc prefix and concat if set
** generate new tags for acqure/require/release
** store all strings in map with timer
** add tags for loop vars, size:1000, cnt:10 etc
** pass tags var as first param 
